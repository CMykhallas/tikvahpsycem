    ...
    return (
      ...
      >
        <div className="flex items-center gap-2 text-slate-600 mb-6">
          ...
          <span className="text-sm font-medium">A carregar catálogo ao vivo do backend…</span>
        </div>
  ...
  if (isError) {
    return (
      <section
        ...
        className="max-w-3xl mx-auto my-10 p-6 border border-amber-200 bg-amber-50 rounded-2xl"
      >
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <button
              type="button"
              onClick={() => refetch()}
              className="mt-3 px-3 py-1.5 text-xs font-semibold rounded-md bg-amber-600 text-white hover:bg-amber-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-700"
            >
              Tentar novamente
            </button>
          </div>
    ...
    >
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2
          ...
          className="text-sm font-bold uppercase tracking-wider text-teal-700"
        >
